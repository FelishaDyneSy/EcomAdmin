...
<head>
    ...
    <link rel="stylesheet" href="home/assets/vendor/vector-map/jqvmap.css">
    <link rel="stylesheet" href="home/assets/vendor/jvectormap/jquery-jvectormap-2.0.2.css">
...
<body>
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="/logins"><i class="fas fa-power-off mr-2"></i>Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <ul class="social-sales list-group list-group-flush">
                                    <li class="list-group-item social-sales-content"><span class="social-sales-icon-circle facebook-bgcolor mr-2"><i class="fab fa-facebook-f"></i></span><span class="social-sales-name">Facebook</span>
                                    </li>
                                    <li class="list-group-item social-sales-content"><span class="social-sales-icon-circle twitter-bgcolor mr-2"><i class="fab fa-twitter"></i></span><span class="social-sales-name">Twitter</span>
                                    </li>
                                    <li class="list-group-item social-sales-content"><span class="social-sales-icon-circle instagram-bgcolor mr-2"><i class="fab fa-instagram"></i></span><span class="social-sales-name">Instagram</span>
                                    </li>
                                </ul>
                            </div>
    ...
    <!-- chartjs js-->
    <script src="home/assets/vendor/charts/charts-bundle/Chart.bundle.js"></script>
    <script src="home/assets/vendor/charts/charts-bundle/chartjs.js"></script>
   
    <!-- main js-->
    <script src="home/assets/libs/js/main-js.js"></script>
    <!-- jvactormap js-->
    <script src="home/assets/vendor/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="home/assets/vendor/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <!-- sparkline js-->
    <script src="home/assets/vendor/charts/sparkline/jquery.sparkline.js"></script>
    <script src="home/assets/vendor/charts/sparkline/spark-js.js"></script>
     <!-- dashboard sales js-->
    <script src="home/assets/libs/js/dashboard-sales.js"></script>
</body>
