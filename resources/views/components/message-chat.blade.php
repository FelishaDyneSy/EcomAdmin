...
<body class="chat-body">
                                        ...
                                        <div class="list-group">
                                            <a href="#" class="list-group-item list-group-item-action active">
                                                <div class="notification-info">
                                                    <div class="notification-list-user-img"><img src="home/assets/images/avatar1.png" alt="" class="user-avatar-md rounded-circle"></div>
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="/ecommerce-product">Product List</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="/ecommerce-product-single">Product Single</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="/ecommerce-product-checkout">Product Checkout</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="/dashboard-sales">Sales</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="content-container">
                    <div class="chat-module">
                        <div class="chat-module-top">
                            ...
                            <div class="chat-module-body mt-3">
                                <div class="media chat-item p-2">
                                    <img alt="William" src="home/assets/images/avatar6.jpg" class="rounded-circle user-avatar-lg ml-3">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                            <span class="chat-item-author m-1">William</span>
                                            <span>4 days ago</span>
                                        </div>
                                        <div class="chat-item-body m-1">
                                ...
                                <div class="media chat-item p-2">
                                    <img alt="Komal" src="home/assets/images/avatar7.jpg" class="rounded-circle user-avatar-lg ml-3">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                            <span class="chat-item-author m-1">Komal</span>
                                            <span>4 days ago</span>
                                        </div>
                                        <div class="chat-item-body m-1">
                                ...
                                <div class="media chat-item p-2">
                                    <img alt="tanu" src="home/assets/images/avatar8.jpg" class="rounded-circle user-avatar-lg ml-3">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                            <span class="chat-item-author m-1">Tanu</span>
                                ...
                                <div class="media chat-item p-2">
                                    <img alt="Bhoomi" src="home/assets/images/avatar9.jpg" class="rounded-circle user-avatar-lg ml-3">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                            <span class="chat-item-author m-1">Bhoomi</span>
                                            <span>3 days ago</span>
                                        </div>
                                        <div class="chat-item-body m-1">
                                            <h1 id="-">😉</h1>
                                ...
                                <div class="media chat-item p-2">
                                    <img alt="William" src="home/assets/images/avatar6.jpg" class="rounded-circle user-avatar-lg m-3">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                            <span class="chat-item-author m-1">William</span>
                                ...
                                <div class="media chat-item p-2">
                                    <img alt="Daniel" src="home/assets/images/avatar2.jpg" class="rounded-circle user-avatar-lg m-3">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                            <span class="chat-item-author">Daniel</span>
                                            <span>Yesterday</span>
                                        </div>
                                        <div class="chat-item-body p-2">
                                ...
                                <div class="media chat-item p-2">
                                    <img alt="Fallon" src="home/assets/images/avatar10.jpg" class="rounded-circle user-avatar-lg m-3">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                ...
                                <div class="media chat-item p-2">
                                    <img alt="Kimberly" src="home/assets/images/avatar11.jpg" class="rounded-circle user-avatar-lg m-3">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                            ...
                            <div class="chat-team-sidebar text-small">
                                <div class="chat-team-sidebar-top">
                                    <div class="media align-items-center">
                                        <a href="#" class="mr-2">
                                            <img alt="Team Avatar" src="home/assets/images/avatar1.png" class="rounded-circle user-avatar-xl">
                                        </a>
                                        <div class="media-body">
                                        ...
                                        <div class="tab-pane fade active show" id="members" role="tabpanel" aria-labelledby="members-tab" data-filter-list="list-group">
                                            <div id="test-list">
                                                ...
                                                <div class="list-group list-group-flush  list">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Marcus Simmons" src="home/assets/images/avatar1.png" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Ravi Singh" src="home/assets/images/avatar1.png" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Krishna Bajaj" src="home/assets/images/avatar1.png"  class="avatar ">
                                                        <div class="media-body ">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="media align-items-center">
                                                            <ul class="avatars list-unstyled">
                                                                ...
                                                                <li>
                                                                    <img alt="Harry Xai" src="home/assets/images/avatar1.png" class="avatar filter-by-data-title" data-title="Harry Xai" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
    ...
    <script src="home/assets/vendor/dropzone/dropzone.js"></script>
